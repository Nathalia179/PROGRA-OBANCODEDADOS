...
ALTER TABLE cursos ALTER COLUMN carga_horaria TYPE SMALLINY;
...
UPDATE alunos SET telefone = '1191111222' WHERE id_aluno = 1;
...
SELECT * FROM cursos ORDEM BY carga_horaria DESC;
...
TIMESTAMPDIFF(YEAR, a.data_nascimento, CURDATE()) AS idade, m.data_matricula
FROM alunos a
JOIN matriculas m ON a.id_aluno = m.id_aluno
JOIN cursos c ON c.id_curso = m.id_curso;
